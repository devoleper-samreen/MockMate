...
const InterviewSelectionPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-10">
            ...
            <Modal open={isMatching} footer={null} closable={false} centered>
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-yellow-400">Matching in Progress...</h2>
                    <p className="text-gray-300 my-6">Searching for an interview match...</p>
            ...
            <Modal open={matchFailed} footer={null} onCancel={() => setMatchFailed(false)} centered>
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-red-500">Match Not Found</h2>
                    <p className="text-gray-300 mt-2">No match found within 30 seconds. Try again later.</p>
                </div>
            </Modal>
        </div>
    );
